...
function bypass_shortlinks($url, $separator = 0) {
    ...
    if (preg_match("#(luckydice.net|kalimbanote.com|cryptoflare.cc|myhealths.icu|clk.st|urlsfly.me|wefly.me|shortsfly.me|linksfly.me)#is", $host)) {
        ...
        } elseif (preg_match("#(go.tinygo.co|s3.addurl.biz|hbz.us)#is", $host)) {
            $referer = "https://wpcheap.net/";
        } elseif (preg_match("#(go.wez.info|s2.addurl.biz)#is", $host)) {
            $referer = "https://aduzz.com/";
        } elseif (preg_match("#(go.viewfr.com|s1.addurl.biz)#is", $host)) {
        ...
        } elseif (preg_match("#(go.bitss.sbs|go.shtfly.com|go.revcut.net.co|l2.revcut.net|121989.xyz|go.urlcut.pro|131989.xyz|go.faho.us|141989.xyz|go.eazyurl.xyz|link.eazyurl.xyz|go.cutlink.xyz)#is", $host)) {
