      ...
      if (strpos($link, "http") !== false) {
        ...
        $knt[] = $url1;
            while(true) {
                ...
                $knt[] = $final;
                #print_r($r);//exit;
                #if (multi_strpos($final, [$host, "go.bitcosite.com"]) !== false) {
                if (strpos($final, "go.bitcosite.com") !== false || strpos($final, $host) !== false) {
