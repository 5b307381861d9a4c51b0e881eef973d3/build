...
#print_r(bypass_shortlinks("https://rsshort.com/VDLJxwM"));clks
    ...
    if(preg_match("#(luckydice.net|kalimbanote.com|cryptoflare.cc|myhealths.icu|clk.st|urlsfly.me|wefly.me|shortsfly.me|linksfly.me)#is",$host)){
     ...
     /* if(preg_match("#(limit)#is",$link)){
      ...
      if($r1){
        ...
        } elseif(preg_match("#(go.tinygo.co|s3.addurl.biz)#is",$host)){
        ...
        } elseif(preg_match("#(go.bitss.sbs|go.shtfly.com|go.revcut.net.co|go.urlcut.pro|go.faho.us|go.eazyurl.xyz|link.eazyurl.xyz)#is",$host)){
...
$method = "recaptchav2";
     ...
     # die(print_r($r));
      ...
      $method = "recaptchav2";
      $cap = multibot($method,$r[$method],$url);
      $data = http_build_query(array("g-recaptcha-response" => $cap, "alias" => str_replace("/","",$parse["path"])));
