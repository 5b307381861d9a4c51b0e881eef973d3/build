...
function bypass_shortlinks($url, $separator = 0) {
    ...
    if (preg_match("#(luckydice.net|kalimbanote.com|cryptoflare.cc|myhealths.icu|clk.st|urlsfly.me|wefly.me|shortsfly.me|linksfly.me|clicksfly.me|3link.co)#is", $host)) {
        ...
        } elseif (preg_match("#(chainfo.xyz)#is", $host)) {
        ...
        if (explode('"', $t[1][2])[0] == "ad_form_data" || explode('"', $t[1][1])[0] == "ad_form_data") {
            ...
            $r1 = base_short(str_replace("pwrpa.cc", "pwrpa.cc/go", str_replace("jameeltips.us", "jameeltips.us/blog", str_replace("techyuth.xyz", "techyuth.xyz/blog", $run["go"][0]))), 1, $data, 0, $cloud, $cookie, 0, $proxyv)["json"];
            #die(print_r($r1));
      ...
      if (strpos($link, "http") !== false) {
        ...
        $knt[] = $url1;
            while(true) {
                ...
                $find = array_merge([$r["url6"]] ?? [], $r["url1"] ?? []);
